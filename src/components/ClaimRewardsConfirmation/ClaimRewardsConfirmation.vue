...
export default {
    ...
    components: { TPCTokenValue, FMessage, FPlaceholder, LedgerConfirmationContent, TxConfirmation },
    ...
    methods: {
        delegatedLimitReached() {
            ...
            this.delegatedLimit = parseFloat(this.$fWallet.WEIToTPC(delegatedLimit)).toFixed(2);
