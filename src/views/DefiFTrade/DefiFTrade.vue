...
export default {
    ...
    methods: {
        async init() {
            ...
            const wTPC = result[1].filter((_token) => _token && _token.canWrapTPC);
            ...
            const tpcToken = {
                ...
                decimals: 18,
                price: wTPC[0].price,
                priceDecimals: wTPC[0].priceDecimals,
                availableBalance: account.balance,
                allowance: '0x0',
                logoUrl: 'https://cryptologos.cc/logos/techpay-tpc-logo.svg?v=003',
            };
