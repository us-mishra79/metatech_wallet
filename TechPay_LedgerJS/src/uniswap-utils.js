...
/**
 * uniswapAddLiquidityTpc creates a contract call transaction to add liquidity
 ...
 * @param {string|{BN}} amountTpcDesired
 * @param {string|{BN}} amountTokenMin
 * @param {string|{BN}} amountTpcMin
 * @param {string} to
 * @param {string|{BN}} deadline
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapAddLiquidityTpc(
    web3,
    routerAddress,
    token,
    amountTokenDesired,
    ...
    return {
        to: routerAddress,
        value: web3Utils.numberToHex(amountTpcDesired),
        data: web3.eth.abi.encodeFunctionCall({
            "constant": false,
            "inputs": [
                {
            ...
            "type": "function"
        }, [token, amountTokenDesired, amountTokenMin, amountTpcMin, to, deadline])
    };
}
...
/**
 * uniswapRemoveLiquidityTpc creates a contract call transaction to remove liquidity
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapRemoveLiquidityTpc(
    web3,
    routerAddress,
    token,
    liquidity,
    ...
    return {
        ...
        data: web3.eth.abi.encodeFunctionCall({
            ...
            "stateMutability": "nonpayable",
            "type": "function"
        }, [token, liquidity, amountTokenMin, amountTpcMin, to, deadline])
    };
}
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapExactTpcForTokens(
    web3,
    routerAddress,
    amountIn,
    amountOutMin,
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapTpcForExactTokens(
    web3,
    routerAddress,
    amountOut,
    amountInMax,
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapTokensForExactTpc(
    web3,
    routerAddress,
    amountOut,
    amountInMax,
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapExactTokensForTpc(
    web3,
    routerAddress,
    amountIn,
    amountOutMin,
...
export default {
    ...
    /*********** liquidity ***********/
    uniswapAddLiquidity,
    uniswapAddLiquidityTpc,
    uniswapRemoveLiquidity,
    uniswapRemoveLiquidityTpc,
    uniswapApproveShareTransfer,

    /*********** SWAP calls **********/
    uniswapExactTokensForTokens,
    uniswapExactTpcForTokens,
    uniswapTokensForExactTokens,
    uniswapTpcForExactTokens,
    uniswapTokensForExactTpc,
    uniswapExactTokensForTpc,
};
