 ...
 * contract to mint tokenized stake sTPC to the sender address representing their locked
 * stake or delegation.
 *
 ...
 * contract to redeem tokens of a tokenized stake sTPC from the sender address.
 * Please note, the tokenizer must be granted allowance on the sTPC token
